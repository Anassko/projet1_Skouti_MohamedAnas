                        ...
                        <div class="row">
                           <div class="col-md-7 col-lg-6 ">
                              <div class="detail-box">
                                 ...
                                 <p>
                                 Enjoy a special 20% discount on everything! Don't miss out on this limited-time offer. Shop now and save on every item. It's the perfect time to explore our products and take advantage of exclusive discounts. Seize the offer before it ends! 🎉 #Sale #Discount #Shopping
                                 </p>
                                 <div class="btn-box">
               ...
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Swift Delivery, Guaranteed Speed.
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Shipping On Us, Absolutely Free
                        </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="box ">
                     ...
                     <div class="detail-box">
                        ...
                        <p>
                        Unmatched Excellence, Best Quality Guaranteed
                        </p>
                     </div>
                  </div>
               </div>
            ...
            <div class="box">
               ...
               <div class="row">
                  <div class="col-md-6 ml-auto">
                     ...
                     <p style="margin-top: 20px;margin-bottom: 30px; cursor: pointer;">
                     Explore the latest in fashion with our New Arrivals in clothing. Elevate your style with the freshest trends and exclusive designs that have just hit the shelves. From statement pieces to everyday essentials, discover a curated selection of fashionable garments that reflect the latest in vogue. Upgrade your wardrobe and stay ahead in the world of fashion with our newest arrivals in clothing, because your style deserves nothing but the best
                     </p>
                     <div class="btn-box">
                                    <a href="product.php" class="btn1">
                                    Shop Now
...
<html>
   <body class="sub_page">
      <section class="section-bg">
         <div class="container">
            <div class="heading_container heading_center pt-2">
               <h2>
               ...
               <div class="row">
                  <div class="col-md-6 offset-md-3">
                     <div class="subscribe_form ">
                        ...
                        <p>Subscribe now for exclusive discount offers</p>
                        <form action="">
                  ...
                  <div class="carousel-item active">
                     <div class="box col-lg-10 mx-auto">
                        ...
                        <div class="detail-box">
                           ...
                           <p>
                           An amazing shopping experience! A wide range of trendy clothes, impeccable quality, and swift delivery. My go-to online store for effortless style. Highly recommend! 👗✨ #FashionParadise #ShoppingBliss
                           </p>
                        </div>
                     </div>
                  </div>
